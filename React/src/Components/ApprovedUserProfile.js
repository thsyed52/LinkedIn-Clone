...
class ApprovedUserProfile extends Component {

    componentWillMount(){
        let {job_id} = this.props.job_id;
        // console.log('hhhhhh',this.props.location.state);
       this.props.dispatch(fetchUserProfile(job_id));
    }
...
export default connect(mapStateToProps)(ApprovedUserProfile);
